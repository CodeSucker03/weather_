export const setPlaceHolderText = () =>{
   const input = document.querySelector("#searchBar_text");
...
const fadeDisplay = ()=>{
    ...
    sixDay.classList.toString("fade-in");
}
const clearDisplay = ()=>{
    const currentConditions = document.getElementById("currentForecast_conditions");
...
const translateIconToFontAwesome = (icon)=>{
    ...
    switch(firstTwoChars){
            ...
            case "10":
            if(lastChar === "d"){
                i.classList.add("fa-solid","far-cloud-sun-rain");
            }else{
...
// const displaySixDayForecast = () => {
//     const WEATHER_API_KEY = "a8805c6e3059c8f144b4ba32511bbbaf";
